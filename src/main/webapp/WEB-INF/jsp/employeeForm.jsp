...
<sec:authorize access="isAuthenticated()">
    ...
    <h3 align="center" style="color: blue">NOWY PRACOWNIK</h3>
    ...
    <table align="center">
        <form:form method="post" modelAttribute="employee">
            ...
            <tr><td>UMIEJĘTNOŚCI</td><td width="200px" height="auto"><form:checkboxes path="skills" items="${skills}" itemLabel="name" itemValue="id" /></td></tr>

            <tr><td></td><td><input style="color: blue" type="submit" value="STWÓRZ PRACOWNIKA"></td></tr>
